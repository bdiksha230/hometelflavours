...
if (isset($_POST['submit'])){
		$to = $_POST["email"];
		$subject = 'Application From Eflystore for Contact from'.$to;
                    ...
                    <div class="outer full_width" style="width:96%;max-width:660px;margin:20px auto;">
                        ...
                        <table role="presentation" width="100%" bgcolor="#ffffff">
                         ...
                         <table role="presentation" width="100%" style="display: contents;">
                           <tr>
                             <td style="padding:0px 10px 0px 10px;font-family:Play, sans-serif; font-size:24px;line-height:1px;font-weight:bold;">
                               <img src="http://weagastyle.com/eflystore/images/contact_banner_mail.png" width="640" alt="" style="width:100%;height:auto;" />
                             </td>
                           </tr>
                         </table>			
						 ...
						 <table role="presentation" width="100%" style="display: contents;">
                           <tr>
                             <td style="padding:0px 10px 0px 10px;font-family:Play, sans-serif; font-size:24px;line-height:1px;font-weight:bold;">
                               <img src="http://weagastyle.com/eflystore/images/contact_mail.png" width="640" alt="" style="width:100%;height:auto;" />
                             </td>
                           </tr>
                         </table>	
                         ...
                         <table role="presentation" width="100%">
                            <tr>
                             <td style="padding:10px 10px 25px 10px;text-align:center;">                  
                               <p style="color:#004568; font-family:Play, sans-serif; margin:0; font-size:20px;line-height:20px;">Thank you for contacting us</p>
                             </td>
                           </tr>
                          
                             <tr>
                             <td style="padding:5px 10px 5px 10px;text-align:left;">                  
                               <p style="color:#797979; font-family:Play, sans-serif; margin:0; font-size:14px;line-height:20px;">WELCOME to <b>eFLyStore India Private Limited</b> </p>
                             </td>
                           </tr>		
                         <tr>
                             <td style="padding:5px 10px 5px 10px;text-align:left;">                  
                               <p style="color:#797979; font-family:Play, sans-serif; margin:0; font-size:14px;line-height:20px;">The eFly store connects conventional and internet markets without establishing a market barrier. Aids in the preservation of the market's equilibrium between the two, which involves not just following trends but also being loyal to one's roots. eFly is your companion in both good and bad times. eFly provides your ideas wings so they can fly smoothly.</p>
                             </td>
                           </tr>	
                        
                         <tr>
                             <td style="padding:5px 10px 5px 10px;text-align:left;">                  
                               <p style="color:#797979; font-family:Play, sans-serif; margin:0; font-size:14px;line-height:20px;">We appreciate you taking a step forward to know more about us and exploring new opportunities. We are glad for your coordination and your time. <br/>Our support team has received your request and is reviewing it. We will respond as quickly as possible. <br/>Reply to this email with any further remarks. </p>
                             </td>
                           </tr>	

							<tr>
                             <td style="padding:5px 10px 5px 10px;text-align:left;">                  
                               <p style="color:#797979; font-family:Play, sans-serif; margin:0; font-size:14px;line-height:20px;">WELCOME  TO OUR COMMUNITY </p>
                             </td>
                           </tr>

							<tr>
                             <td style="padding:5px 10px 5px 10px;text-align:left;">                  
                               <p style="color:#797979; font-family:Play, sans-serif; margin:0; font-size:14px;line-height:20px;">Thank You,</p>
                             </td>
                           </tr>
						...
						<tr>
						 ...
						 <tr>
                             <td style="padding:5px 10px 5px 10px;text-align:left;">                  
                               <p style="color:#797979; font-family:Play, sans-serif; margin:0; font-size:14px;line-height:20px;">For Support: <br/>Contact us at : support@eflystoreindia.com <br/>call us: - 9923961960<br/>For more information visit : <a href="https://www.eflystoreindia.com" style="color:blue;" >https://www.eflystoreindia.com</p>
                             </td>
                           </tr>  
...
if($status == 1){
	echo "Thank you. Your application sent successfully";
}
 	}
?>
